...
class player{ //class to hold certain variables pertaining to the player.
	...
	void playerDeath(){ //a void is a function that can be called on at any time, anywhere in the code.
		...
		ArrayList<String> deaths = new ArrayList<String>(Arrays.asList("The darkness of the afterlife is all that awaits you now. May you find more peace in that world than you found in this one.", "Not even the carrion eaters are interested in your irradiated corpse...", "Your life ends in the wasteland.", "You fought valiantly, but to no avail. Your twisted and ruined body goes down in a hail of bullets... and thus ends your life in the wasteland.", "You have perished.", "Rest in peace."));
